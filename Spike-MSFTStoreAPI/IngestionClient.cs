...
namespace MSFTDevCenterGetAppInfo
{
    ...
    public class IngestionClient : IDisposable
    {
        ...
        public static readonly string GetStoreAppListingUrlTemplate = "/v{0}/{1}/applications";
        public static readonly string GetStoreAppListingRangeUrlTemplate = "/v{0}/{1}/applications?skip={2}&top={3}";
